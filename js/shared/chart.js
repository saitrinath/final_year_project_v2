$(function () {
  ...
  if ($("#lineChart").length) {
    var lineData = {
      ...
      datasets: [{
        data: [65, 64, 63, 63, 64, 64, 67, 68, 68,65, 64, 63, 63, 64, 64, 67, 68, 68],
        backgroundColor: ChartColor[0],
        borderColor: ChartColor[0],
        borderWidth: 3,
        fill: 'false',
	...
	async function update_chart_heart(){
			
			//get data
				  await fetch('http://192.168.43.75:5000/API/sensors/heart_rate_history')
			.then(res => res.json())
			.then((out) => {
				console.log('heart_rate_history: received');
		  
			var data_5_1 = out['heart_rate'];
		...
		//update chart			
				...
				var sss11=setInterval(update_chart_heart,10000);
